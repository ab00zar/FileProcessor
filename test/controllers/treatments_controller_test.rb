...
class TreatmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create treatment" do
    assert_difference('Treatment.count') do
      post treatments_url, params: { treatment: { created_by: @treatment.created_by, file1: @treatment.file1, file2: @treatment.file2, result: @treatment.result } }
    end
  ...
  test "should update treatment" do
    patch treatment_url(@treatment), params: { treatment: { created_by: @treatment.created_by, file1: @treatment.file1, file2: @treatment.file2, result: @treatment.result } }
